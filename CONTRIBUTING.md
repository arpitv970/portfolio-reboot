...
2. **Clone your fork**
   ```bash
   git clone https://github.com/YOUR_USERNAME/portfolio-reboot.git
   cd portfolio-reboot
   ```

3. **Add upstream remote**
   ```bash
   git remote add upstream https://github.com/arpitv970/portfolio-reboot.git
   ```
...
2. **Create a Pull Request**
   ...
   - **Base repository**: `arpitv970/portfolio-reboot` (upstream)
   - **Base branch**: `main`
...
- Open a [Question issue](https://github.com/arpitv970/portfolio-reboot/issues/new?template=question.md)
